...
try{
    ...
    $query = $writeDB->prepare('SELECT id, userid, title, description, DATE_FORMAT(deadline, "%d/%m/%Y %H:%i") as deadline, completed FROM tbl_tasks WHERE id= :taskid AND userid = :userid');
